...
! golden2d_main_omp.f90

program golden2d_main
    implicit none
    ...
    ! print "('Solving Laplace equation on',i4,' by',i4,' grid by SOR iteration')", n,n
    ...
    nthreads = 1
    call golden2d_sub(n, tol, maxiter, iter, dumax, nthreads)

    nthreads = 2
    call golden2d_sub(n, tol, maxiter, iter, dumax, nthreads)


end program golden2d_main
