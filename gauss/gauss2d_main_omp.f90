...
! gauss2d_main_omp.f90

program gauss2d_main
    implicit none
    ...
    ! print "('Solving Laplace equation on',i4,' by',i4,' grid by Gauss-Seidel iteration')", n,n
    ...
    nthreads = 1
    call gauss2d_sub(n, tol, maxiter, iter, dumax, nthreads)

    nthreads = 2
    call gauss2d_sub(n, tol, maxiter, iter, dumax, nthreads)


end program gauss2d_main
