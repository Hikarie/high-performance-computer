...
! redblack2d_main_omp.f90

program redblack2d_main
    implicit none
    ...
    write (*,"('Solving Laplace equation on',i4,' by',i4,' grid by redblack iteration')") n,n
    ...
    nthreads = 1
    call redblack2d_sub(n, tol, maxiter, iter, dumax, nthreads)

    nthreads = 2
    call redblack2d_sub(n, tol, maxiter, iter, dumax, nthreads)


end program redblack2d_main
